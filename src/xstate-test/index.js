...
var TestModel =
  ...
  (function() {
    ...
    TestModel.prototype.getShortestPathPlansTo = function(stateValue) {
      ...
      try {
        for (
          var plans_1 = __values(plans), plans_1_1 = plans_1.next();
          !plans_1_1.done;
          plans_1_1 = plans_1.next()
        ) {
        ...
        try {
          if (plans_1_1 && !plans_1_1.done && (_a = plans_1.return))
            _a.call(plans_1);
        } finally {
    ...
    TestModel.prototype.getSimplePathPlans = function(options) {
      var simplePaths = getSimplePaths(
        this.machine,
        __assign(__assign({}, options), {
          events: getEventSamples(this.options.events)
        })
                ...
                return __generator(this, function(_b) {
                  switch (_b.label) {
                    ...
                    case 2:
                      ...
                      (segments_1 = __values(segments)),
                        (segments_1_1 = segments_1.next());
                      _b.label = 3;

                    case 3:
                      if (!!segments_1_1.done)
                        return [
                          3,
                          /*break*/
                          11
                    ...
                    case 18:
                      ...
                      err_4.message +=
                        ...
                        testPathResult.segments
                          .map(function(s) {
                            var stateString =
                              JSON.stringify(s.segment.state.value) +
                              " " +
                              (s.segment.state.context === undefined
                                ? ""
                                : JSON.stringify(s.segment.state.context));
                            var eventString =
                              "" + JSON.stringify(s.segment.event);
                            var stateResult =
                              "\tState: " +
                              (hasFailed_1
                                ? stateString
                                : s.state.error
                                ? ((hasFailed_1 = true), stateString)
                                : stateString);
                            var eventResult =
                              "\tEvent: " +
                              (hasFailed_1
        ...
        return __generator(this, function(_d) {
          switch (_d.label) {
            ...
            case 1:
              ...
              if (
                !(
                  typeof stateNodeMeta.test === "function" &&
                  !stateNodeMeta.skip
                )
              )
                return [
    ...
    TestModel.prototype.getCoverage = function(options) {
      ...
      try {
        for (
          var _b = __values(this.coverage.stateNodes.keys()), _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
          var key = _c.value;
    ...
    TestModel.prototype.testCoverage = function(options) {
      ...
      var missingStateNodes = Object.keys(coverage.stateNodes).filter(function(
        id
      ) {
...
function getEventSamples(eventsOptions) {
  ...
  Object.keys(eventsOptions).forEach(function(key) {
    ...
    result[key] = eventConfig.cases
      ? eventConfig.cases.map(function(sample) {
          return __assign(
            {
              type: key
            },
